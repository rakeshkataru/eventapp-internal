...
//        e.g https://github.com/rakeshkataru/eventapp-internal.git might become https://github.com/MyName/external.git
// variables:
//      roidtc-april2022-u211
...
//      https://github.com/rakeshkataru/eventapp-internal.git
//      rakeshkataru
//      internal
//      cluster-1 
...
pipeline {
   ...
   environment {
        ...
        imageName = 'rakeshkataru/internal'
        dockerImage = ''
        }
    stages {
        stage('Run the tests') {
            ...
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/rakeshkataru/eventapp-internal.git'
        ...
        stage('Building image') {
         ...
         stage('get k8s credentials') {
            ...
            steps {
                ...
                sh 'gcloud container clusters get-credentials cluster-1 --zone us-central1-c --project roidtc-april2022-u211'
            }
        }     
         stage('update k8s') {
             agent {
